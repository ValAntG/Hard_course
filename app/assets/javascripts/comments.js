$(document).on("turbolinks:load", function () {
  ...
  .bind('ajax:success', function (evt) {
    if (evt.detail[0].DOCUMENT_TYPE_NODE == 10) {
      ...
      $('.comments-show-form').find('.form-horizontal').find('.form-group').last().append('<div class="col-sm-3"></div>');
      ...
      $('.comments-show-form').find('.form-horizontal').find('.form-group').last().append('<div class="col-sm-9"></div>');
